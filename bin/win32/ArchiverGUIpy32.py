#Version Check Fluff (from CEFPython Examples)
import platform
...
#From Cefpython example. (Required for URL navigation)
...
class MainFrame(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        jsBindings.SetProperty("pyConfig", ["This was set in Python", {"name": "Nested dictionary", "isNested":True}, [1, "2", None]])
...
#Allows you to print directly to the python console. From CEFPython example
def PyPrint(message):
    print(message)
...
if __name__ == '__main__':
    ...
    settings = {}
    settings["log_file"] = "debug.log"#GetApplicationPath("debug.log")
